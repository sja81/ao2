...
<table class="table1" cellspacing="0">
    <tr>
        ...
        <td colspan="2" valign="middle" style="font-size: 16px; border-left: 1px solid black;padding-left: 10px;padding-top:10px;">VÝDAVKOVÝ POKLADNIČNÝ DOKLAD</td>
    </tr>
    <tr>
...
<table class="table2 pad-10">
    <tr>
        <td colspan="2">Vyplatené komu:</td>
    ...
    <tr>
        ...
        <td rowspan="5" width="50%">
            <table class="table3" cellspacing="0">
                ...
                <tr>
                    <td width="50%" align="center">Má dať - účet</td>
