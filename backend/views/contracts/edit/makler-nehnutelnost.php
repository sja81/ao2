...
$this->title="Zmena zákazky č. {$zmluva->cislo}";
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="<?=Url::to(['contracts/save-makler-nehnutelnost'])?>" method="post" enctype="multipart/form-data" id="form-makler">
                ...
                <input type="hidden" name="Data[zmluva_id]" value="<?= $zmluva->id ?>" id="zmluva-id">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" class="form-control" name="Data[cislo]" value="<?= $zmluva->cislo ?>" id="zmluva-cislo">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select class="form-control select-drop" name="Data[agent][id]" id="main-agent" onchange="getComission()">
                                            ...
                                            foreach($agents as $item) {
                                                $selected='';
                                                if (isset($agent) && $agent->id == $item['id']) {
                                                    $selected = ' selected';
                                                }
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control select-drop" name="Data[kategoria]" id="kategoria">
                                    ...
                                    foreach ($kategorie as $item) {
                                        $selected = '';
                                        if ($item['id'] == $nehnutelnost->nehnutKategoria->id) {
                                            $selected = ' selected';
                                        }
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <?php
                                    $value = $nehnutelnost->druh->id;
                                    $text = $nehnutelnost->druh->nazov;
                                ?>
