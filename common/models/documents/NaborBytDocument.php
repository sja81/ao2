...
final class NaborBytDocument extends Documents implements IContractDocument
{
    ...
    protected function getTemplateData()
    {
        ...
        $sql = "select 
                    ...
                    concat(
                        if(pb.bazen is not null and pb.bazen!=0,'<li>bazén</li>',''),
                        ...
                        if(pb.klima is not null and pb.klima!=0,'<li>klíma</li>',''),
                        if(pb.chodba is not null and pb.chodba!=0,'<li>chodba</li>',''),
                        if(pb.sauna is not null and pb.sauna!=0,'<li>sauna</li>',''),
                        if(pb.pevna_linka is not null and pb.pevna_linka!=0,'<li>pevná linka</li>',''),
                        if(pb.solarium is not null and pb.solarium!=0,'<li>solárium</li>',''),
                        if(pb.letna_kuchyna is not null and pb.letna_kuchyna!=0,'<li>letná kuchyňa</li>',''),
                        if(pb.altanok is not null and pb.altanok!=0,'<li>altánok</li>',''),
                        if(pb.video_vratnik is not null and pb.video_vratnik!=0,'<li>video vrátnik</li>',''),
                        if(pb.zimna_zahrada is not null and pb.zimna_zahrada!=0,'<li>zimná záhrada</li>',''),
