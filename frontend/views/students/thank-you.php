...
<main class="site-student">
    ...
    <div id="students" class="container-fluid">
        <div class="students-container">
            <section>
                <h1 style="font-weight: bold"><?= Yii::t('app','Vaša registrácia prebehla úspešne'); ?></h1>
                <p style="margin-top: 30px">
                    <?= Yii::t('app','Na Vami zadanú emailovú adresu sme poslali správu s ďalšími inštrukciami'); ?>
                </p>
